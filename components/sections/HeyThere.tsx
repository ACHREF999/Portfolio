...
function HeyThere() {
  return (
      <div className=" mx-auto scale-[85%] flex flex-col h-fit w-[80%]  items-center  group cursor-default max-w-[600px] ">
          <div className="flex flex-col items-center relative w-full h-fit border-text group-hover:border-beige border-opacity-60  border-[1px] pb-2 mb-[10%] transition-all">
              {/* border */}

              <div className="absolute -top-[5%] border-text group-hover:border-beige border-opacity-60 border-2 w-[90%] h-[110%] transition-all"></div>
              {/* Image Content */}
          ...
          {/* Available */}
          <span
          className="text-xl hover:text-title hover:underline flex flex-row items-center transition"
          >
